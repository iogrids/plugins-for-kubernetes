<div class="row">
  <div class="col-xs-12" id="sub-menu">
    <ul class="breadcrumb">
            ...
            <?php if ($navigation[2] == 'bots') { ?>
              <li <?php if ($navigation[3] == 'rapidbuilder.php' or !$navigation[3]) { echo 'class="active"'; } ?>><a href="<?php echo get_absolute_url();?>tracking202/bots/rapidbuilder.php">Rapid Builder</a></li> 
            <?php } ?>
          ...
          <?php if ($navigation[2] == 'export') { ?>
              <li <?php if ($navigation[3] == 'index.php' or !$navigation[2]) { echo 'class="active"'; } ?>><a href="<?php echo get_absolute_url();?>tracking202/export/index.php">Export Adwords GCLID</a></li>
             <!-- <li <?php if ($navigation[3] == 'index.php' or !$navigation[2]) { echo 'class="active"'; } ?>><a href="<?php echo get_absolute_url();?>tracking202/export/indexfb.php">Export Facebook FBCLID</a></li>-->
              <li <?php if ($navigation[3] == 'indexbing.php') { echo 'class="active"'; } ?>><a href="<?php echo get_absolute_url();?>tracking202/export/indexbing.php">Export Bing MSCKLID</a></li>
          <?php } ?>
    </ul>
  </div>
</div>  