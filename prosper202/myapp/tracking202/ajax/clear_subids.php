...
AUTH::require_user();
	...
	if ($_POST['aff_network_id'] == 0) { $error['clear_subids'] = '<div class="error"><small><span class="fui-alert"></span>You have to at least select a Category to clear out</small></div>'; }
