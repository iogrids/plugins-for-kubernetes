...
$user_sql = "SELECT 202_users.user_name AS username, 202_users_pref.maxmind_isp, 202_users_pref.ipqs_api_key,202_users_pref.user_slack_incoming_webhook AS url FROM 202_users_pref LEFT JOIN 202_users ON (202_users.user_id = '".$mysql['user_own_id']."') WHERE 202_users_pref.user_id='1'";
					...
					<div class="criteria" id="criteria" data-criteria-id="none">
						<div class="form-group">
							...
							<select class="form-control input-sm" name="rule_type" style="margin: 0px 5px;">
								...
								<option value="eu">Is European Union</option>
								<option value="city">Cities</option>
								<option value="isp" <?php if(!$user_row['maxmind_isp']) echo "disabled";?>>ISP/Carrier</option>
								<option value="fraud" <?php if(!$user_row['ipqs_api_key']) echo "disabled";?>>High Fraud Score</option>
						...
						<div class="form-group" id="tags_select">
							...
							<input id="tag" class="value_select" name="value" placeholder="Type in value and hit Enter"/>
						</div>
						<div class="form-group">
									...
									<?php
										...
										if ($criteria_result->num_rows == 0) { ?>
											<div class="criteria" id="criteria" data-criteria-id="none">
												...
												<div class="form-group">
													<label for="rule_value">equal to:</label>
													<input id="tag_<?php echo $criteria_row['id'];?>" class="value_select" name="value" placeholder="Type in value and hit Enter"/>
												</div>
											...
											<div class="criteria" id="criteria" data-criteria-id="<?php echo $criteria_row['id'];?>">
														<div class="form-group">
															...
															<select class="form-control input-sm" name="rule_type" style="margin: 0px 5px;">
																...
																<option value="eu" <?php if($criteria_row['type'] == 'eu') echo "selected";?>>Is European Union</option>
																...
																<option value="fraud" <?php if($criteria_row['type'] == 'fraud') echo "selected";?> <?php if(!$user_row['ipqs_api_key']) echo "disabled";?>>High Fraud Score</option>
													...
													<script type="text/javascript">
														$(document).ready(function() {
															...
															<?php } elseif ($criteria_row['type'] == 'eu') { ?>
																rotator_tags_autocomplete_truefalse("tag_<?php echo $criteria_row['id'];?>");
