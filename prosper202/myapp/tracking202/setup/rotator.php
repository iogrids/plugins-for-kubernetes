	...
	<div class="col-xs-5">
		<div class="panel panel-default">
			...
			<?php if($_SESSION['user_pref_ad_settings']!='hide_all'){?>
		      <iframe id="adframe" src="<?php echo TRACKING202_ADS_URL; ?>/prosper202-redirector/?t202aid=<?php echo $_SESSION['user_cirrus_link']; ?>" scrolling="no" frameborder="0" height="240"> </iframe>
		    <?php }?>		
			...
			<?php
				...
				while ( $row = $result->fetch_array (MYSQLI_ASSOC) ) {
					...
					if ($userObj->hasPermission("remove_rotator")) {
						printf ( '<li><span class="filter_rotator_name">%s</span> - <a href="?delete_rotator_id=%s&delete_rotator_name=%s" onclick="return confirmAlert(\'Are You Sure You Want To Delete This Redirector?\');">remove</a></li>', $html ['name'], $html ['id'], $html ['name'] );
					} else {
