	...
	<div class="col-xs-6">
		<form id="cpc_form" method="post" action="" class="form-horizontal" role="form" style="margin:0px 0px 0px 15px;">
			...
			<div id="tracker_aff_network" class="form-group" style="margin-bottom: 0px;">
		        <label for="aff_network_id" class="col-xs-5 control-label" style="text-align: left;">Category:</label>
		    ...
		    <div class="form-group" style="margin-bottom: 0px;">
		        <label for="ppc_network_id" class="col-xs-5 control-label" style="text-align: left;">Traffic Source:</label>
		        <div class="col-xs-7" style="margin-top: 10px;">
		    ...
		    <div class="form-group" style="margin-bottom: 0px;">
		        <label for="ppc_account_id" class="col-xs-5 control-label" style="text-align: left;">Traffic Source Account:</label>
		        <div class="col-xs-7" style="margin-top: 10px;">
