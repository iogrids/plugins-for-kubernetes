...
if(isset($_POST['element_id']) && is_int())
{
	$element_id =  $_POST['element_id'];
}
else{
	$element_id =  rand(10000,99999);
}
...
<div class="form-group" style="margin-bottom: 0px;">
	...
	<div class="col-xs-5">
		<select class="form-control input-sm" name="pixel_type_id[]" id="pixel_type_id_<?php echo $element_id ;?>">
			<option value="">---</option>
				<?php
					$ppc_network_sql = "SELECT * FROM `202_pixel_types` ORDER BY `pixel_type_id` ASC";
...
<label for="pixel_code" class="col-xs-4 control-label" style="text-align: left;">Pixel Code:</label> 
	<div class="col-xs-5">
		<textarea class="form-control" name="pixel_code[]" id="pixel_code_<?php echo $element_id ;?>" rows="3"></textarea>				    
