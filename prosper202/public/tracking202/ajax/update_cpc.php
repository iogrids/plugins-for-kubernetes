...
//check Category id, that you own
	if ($_POST['aff_network_id']) {
		...
		$html['aff_network_name'] = 'ALL your Categories';		
	}
...
//check aff_campaign id, that you own
	if ($_POST['aff_campaign_id']) {
		...
		$html['aff_campaign_name'] = 'ALL your campaigns in these Categories';        
	}    
...
//check text_ad id, that you own
	if ($_POST['text_ad_id']) {
		...
		$html['text_ad_name'] = 'ALL your text ads in these campaigns';        
	}
...
//check landing_page id, that you own
	if (($_POST['method_of_promotion'] == 'landingpage') or ($_POST['tracker_type'] == 1))  { 
		if ($_POST['landing_page_id']) {
			...
			$html['landing_page_name'] = 'ALL your landing pages in these campaigns';        
		}
	} else {
...
//check Category id, that you own
	if ($_POST['ppc_network_id']) {
		...
		$html['ppc_network_name'] = 'ALL Your Traffic Sources';        
	}
...
//check ppc_account id, that you own
	if ($_POST['ppc_account_id']) {
		...
		$html['ppc_account_name'] = 'ALL your Traffic Source accounts in these Traffic Sources';        
	}  
...
<?php if ($_POST['tracker_type'] == 0) { ?>
	<strong>Category:</strong> <em><?php echo $html['aff_network_name']; ?></em><br/>
...
<?php } ?>
	...
	<strong>Traffic Source:</strong> <em><?php echo $html['ppc_network_name']; ?></em><br/>
	<strong>Traffic Source Account:</strong> <em><?php echo $html['ppc_account_name']; ?></em><br/>
