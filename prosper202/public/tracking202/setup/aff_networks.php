...
<div class="row" style="margin-bottom: 15px;">
	...
	<div class="col-xs-12">
		<small>Add categories for the offer you will you work with here. Such as "Lead Gen", "Mobile CPI", "CPA" or "E-Commerce CPS".</small>
	</div>
</div>
...
<div class="row">
	<div class="col-xs-7">
		...
		<span class="infotext">What Campaign Categories do you want to use?</span>
	...
	<div class="col-xs-4 col-xs-offset-1">
		<div class="panel panel-default">
			...
			<?php if($_SESSION['user_pref_ad_settings']!='hide_all'){?>
		      <iframe id="adframe" src="<?php echo TRACKING202_ADS_URL; ?>/prosper202-category/?t202aid=<?php echo $_SESSION['user_cirrus_link']; ?>" scrolling="no" frameborder="0"> </iframe>
		    <?php }?>	
			<div id="networkList">
