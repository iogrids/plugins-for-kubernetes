...
<div class="row">
	<div class="col-xs-5">
		<form id="tracking_form" method="post" action="" class="form-horizontal" role="form" style="margin:0px 0px 0px 15px;">			
			<div class="form-group" style="margin-bottom: 0px;" id="deferred-pixels">
				<label class="col-xs-5 control-label" style="text-align: left;">Activate Deferred Pixel:</label>

				<div class="col-xs-6" style="margin-top: 15px;">
					<div class="row">
						<div class="col-xs-6">
							<label class="radio">
		            			<input type="radio" name="deferred_pixel_status" value="0" data-toggle="radio" checked="">
		            				No 
		          			</label>
						</div>
						...
						<div class="col-xs-6">
							<label class="radio">
			            		<input type="radio" name="deferred_pixel_status" value="1" data-toggle="radio">
			            			Yes 
			          		</label>
						</div>
					</div>
			...
			<input type="hidden" name="secure_type" value="1">
		</form>
	</div>	
</div>
